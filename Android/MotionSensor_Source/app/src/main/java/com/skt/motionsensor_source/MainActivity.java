package com.skt.motionsensor_source;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    Sensor sensor_Gravity; // 중력
    Sensor sensor_Accelerometer; // 가속도
    Sensor sensor_LinearAcceleration; // 선가속도
    Sensor sensor_Gyroscope; // 자이로스코프
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sensor_Gyroscope = objSMG.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION);
